...
const FullDay = () => {
  ...
  return (
    <div className={cx("container")}>
      <h1>Full Day Trip Mt.Fuji & Hakone Digest 12 Hours From/To Tokyo City</h1>
          ...
          <div className={cx("content-left")}>
            ...
            <div className={cx("overview")}>
              ...
              <p className={cx("break-word")}>
                Explore Mt. Fuji and Hakone in a private vehicle driven by a
                professional tour guide-driver. Visit different sightseeing
                spots in the area, including Saiko Iyashino Sato, Mt. Fuji 5th
                Station and Oshino Hakkai in Yamanashi Prefecture, and Owakudani
                Death Valley. Enjoy a Lake Ashi cruise and the fantastic view of
                Mt. Fuji in Kanagawa Prefecture!
              </p>
            </div>
            {/* Highlight */}
            ...
            <div className={cx("description")}>
              <h2>Description</h2>
              <p className={cx("break-word")}>
                On this private tour, you will see the top attractions in the
                Mt. Fuji area and Hakone. Driven by a professional tour
                guide-driver, explore the area at your own pace. Your
                guide-driver will play triple roles, as a driver, as a tour
