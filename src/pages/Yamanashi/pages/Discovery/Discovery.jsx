...
const Discovery = () => {
  ...
  return (
    <div className={cx("container")}>
      <h1>
        Mt.Fuji Discovery: Scenic Bus Tour with Pagoda Views, Traditional Lunch,
        & English Guide from Tokyo
      </h1>
          ...
          <div className={cx("content-left")}>
            ...
            <div className={cx("overview")}>
              ...
              <p className={cx("break-word")}>
                Enjoy a comfortable modern bus tour with high Japanese standards
                of service and a professional English-speaking guide. This is a
                convenient tour that lets you enjoy the World Heritage site of
                Mt. Fuji in one day, with a Japanese lunch at the Japanese
                restaurant Kokorogi. And you'll stop at Arakurayama Sengen Park,
                a scenic spot where you can see the magnificent Mt. Fuji in the
                same view as the famous five-storied pagoda.
              </p>
            </div>
            {/* Highlight */}
