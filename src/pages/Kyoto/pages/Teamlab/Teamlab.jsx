...
const Teamlab = () => {
  ...
  return (
    <div className={cx("container")}>
      <h1>teamLab Planets TOKYO DMM Admission Ticket</h1>
          ...
          <div className={cx("content-left")}>
            ...
            <div className={cx("overview")}>
              ...
              <p className={cx("break-word")}>
                &apos;Book teamLab Planets TOKYO tickets and journey through
                massive digital artworks based on the concept of "Body
                Immersive." Step barefoot into the teamLab Toyosu museum, and
                immerse yourself in artwork-spaces that blur the line between
                visitor and art. The teamLab Planets tickets’ price depends on
                the date, so the price shown will change depending on the date
                selected when booking. The number of visitors is growing fast,
                and tickets often sell out. Advance booking is a must!
              </p>
            </div>
            {/* Highlight */}
            ...
            <div className={cx("description")}>
              <h2>Description</h2>
              <p className={cx("break-word")}>
                Description Immerse your Body, and with Others, Become One with
                the World teamLab Planets is a museum where you walk through
                water, and a garden where you become one with the flowers. There
                are four massive exhibition spaces and two gardens.
              </p>

              <div className={cx("break-word")}>
                How it works For group bookings (15 people or more) please order
                from the group tickets page:
