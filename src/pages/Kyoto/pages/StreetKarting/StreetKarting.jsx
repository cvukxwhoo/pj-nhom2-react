...
const StreetKarting = () => {
  ...
  return (
    <div className={cx("container")}>
      <h1>Street Go Karting Experience in Akihabara</h1>
          ...
          <div className={cx("content-left")}>
            ...
            <div className={cx("overview")}>
              ...
              <p className={cx("break-word")}>
                Rent go-karts and ride around Akihabara, Tokyo — cosplay as your
                favorite characters and blaze through the streets of
                Tokyo&apos;s gaming, anime, and manga mecca! Japanese
                driver&apos;s license, Japanese SOFA license, or an
                International Driving Permit required. All guests will also be
                accompanied by a guide-driver.
              </p>
            </div>
            {/* Highlight */}
            ...
            <div className={cx("description")}>
              <h2>Description</h2>
              <p className={cx("break-word")}>
                Before you set off, take the opportunity to don a wacky costume
                or dress up as your favorite game character. Then, after a short
                instructional session, hop into your kart, and imagine yourself
                transported into a colorful video game world as you take to the
                streets of Tokyo, one of the most vibrant cities in the world!
              </p>
