...
const Odawara = () => {
  ...
  return (
    <div className={cx("container")}>
      <h1>Odawara–Kyoto Bullet Train Shinkansen Tickets</h1>
          ...
          <div className={cx("content-left")}>
            ...
            <div className={cx("overview")}>
              ...
              <p className={cx("break-word")}>
                Speed between Odawara and Kyoto with reserved Shinkansen bullet
            ...
            <div className={cx("description")}>
              ...
              <p className={cx("break-word")}>
                ...
                easy inter-city travel across Japan. With Odawara-to-Kyoto
                bullet train tickets (or Kyoto-to-Odawara bullet train tickets),
                you'll cruise along the Tokaido Shinkansen at incredible speed
