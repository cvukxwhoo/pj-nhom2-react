...
const SamuraiRestaurant = () => {
  ...
  return (
    <div className={cx("container")}>
      <h1>
        11% OFF vs Door Price! Samurai Restaurant Show Reservation in Shinjuku
        Tokyo
      </h1>
          ...
          <div className={cx("content-left")}>
            ...
            <div className={cx("overview")}>
              ...
              <p className={cx("break-word")}>
                Overview There&apos;s a new show in town: Samurai Restaurant
                Time at GiraGiraGirls in Shinjuku! Inspired by iconic, madcap
                performances that put this area on the map, this is Kabukicho
                entertainment reborn.
              </p>
            </div>
            {/* Highlight */}
            ...
            <div className={cx("description")}>
              <h2>Description</h2>
              <p className={cx("break-word")}>
                Tokyo&apos;s red-light district of Kabukicho in Shinjuku has
                long been a place to see only-in-Japan dinner shows where the
                main appeal is the “WTF factor.” Finally, after a long dry
                spell, you can indulge again in a madcap performance you won't
                find anywhere else.
              </p>
