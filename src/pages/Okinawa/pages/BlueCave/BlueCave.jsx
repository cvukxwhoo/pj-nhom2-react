...
const BlueCave = () => {
  ...
  return (
    <div className={cx("container")}>
      <h1>
        Okinawa Blue Cave Diving 29% OFF! vs. Direct Booking & Onsite Payment
      </h1>
          ...
          <div className={cx("content-left")}>
            ...
            <div className={cx("overview")}>
              ...
              <p className={cx("break-word")}>
                Explore Okinawa's stunning Blue Cave at Cape Maeda, Onna Village
                in this two-hour diving experience. Meet colorful tropical fish
                and see fascinating coral reefs up close! Book now with Rakuten
                Travel Experiences for 29% off the price of direct booking and
                onsite payment!
              </p>
            </div>
            {/* Highlight */}
            ...
            <div className={cx("description")}>
              <h2>Description</h2>
              <p className={cx("break-word")}>
                Dive into Okinawa's Blue Cave and swim with the rich variety of
                marine life in its sparkling blue waters. Located at Cape Maeda
                in Onna Village, the Blue Cave is famous for its beautiful glow
                and fish sightings.
              </p>
