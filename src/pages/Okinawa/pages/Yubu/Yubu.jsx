...
const Yubu = () => {
  ...
  return (
    <div className={cx("container")}>
      <h1>Yubu Island Sightseeing and Mangrove Tour by SUP or Canoe</h1>
          ...
          <div className={cx("content-left")}>
            ...
            <div className={cx("overview")}>
              ...
              <p className={cx("break-word")}>
                A plan that combines Yubu Island sightseeing with stand-up
                paddleboarding or canoeing in mangroves! Explore the mangroves
                of the cool spot Kula River on Iriomote Island, while paddling
                and trekking your way to the beautiful spot "Lucky Waterfall."
              </p>
            </div>
            {/* Highlight */}
            ...
            <div className={cx("description")}>
              <h2>Description</h2>
              <p className={cx("break-word")}>
                Book a full-day package that combines canoeing or stand-up
                paddleboarding (SUP) in mangroves, with Yubu Island sightseeing!
                You'll explore the mangrove forests of the cool spot "Kula
                River" on Iriomote Island, while paddleboarding or canoeing!
                Along the way, there is plenty of trekking in Iriomote's nature.
                The goal of your hike will be the beautiful spot "Lucky
                Waterfall."
              </p>
