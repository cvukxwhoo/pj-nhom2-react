...
const Umeda = () => {
  ...
  return (
    <div className={cx("container")}>
      <h1>Umeda Sky Building Floating Garden Observatory Tickets</h1>
          ...
          <div className={cx("content-left")}>
            ...
            <div className={cx("overview")}>
              ...
              <p className={cx("break-word")}>
                See the dynamic Osaka cityscape with a whole new perspective
                from Umeda Sky Building Floating Garden Observatory. Perched 170
                meters above the bustling city, the open-air Sky Walk offers
                truly stunning panoramic vistas day and night.
              </p>
            </div>
            {/* Highlight */}
