...
const Sakishima = () => {
  ...
  return (
    <div className={cx("container")}>
      <h1>Osaka Sakishima Observatory Advance Ticket</h1>
          ...
          <div className={cx("content-left")}>
            ...
            <div className={cx("overview")}>
              ...
              <p className={cx("break-word")}>
                A landmark of the Osaka Bay area, towering in the center of
                Sakishima. The magnificent panoramic 360-degree unobstructed
                observation deck, 252 meters above the ground, offers an
                impressive view as if you were looking down from the heavens.
              </p>
            </div>
            {/* Highlight */}
            ...
            <div className={cx("description")}>
              <h2>Description</h2>
              <p className={cx("break-word")}>
                Towering in the center of the new downtown, landmark of Osaka
                Bay area. Unobstructed ground 252m, 360 degrees. From the
                spectacular panoramic outlook space. It spreads impressive
                views, such as looking down from heaven.
              </p>
